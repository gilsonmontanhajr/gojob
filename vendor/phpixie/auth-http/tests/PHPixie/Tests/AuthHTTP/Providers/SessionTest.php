...
namespace PHPixie\Tests\AuthHTTP\Providers\Type;

/**
 * @coversDefaultClass \PHPixie\AuthHTTP\Providers\Type\Session
 */
class SessionTest extends \PHPixie\Tests\Auth\Providers\Provider\ImplementationTest
{
    ...
    {
        return new \PHPixie\AuthHTTP\Providers\Session(
