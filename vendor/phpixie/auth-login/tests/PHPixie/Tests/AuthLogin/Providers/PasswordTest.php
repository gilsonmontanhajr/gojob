...
class PasswordTest extends \PHPixie\Tests\Auth\Providers\Provider\ImplementationTest
{
    ...
    {
        return $this->quickMock('\PHPixie\AuthLogin\Repository');
    }
    
    protected function getUser()
    {
        return $this->quickMock('\PHPixie\AuthLogin\Repository\User');
    }
    
    protected function provider()
    {
        return new \PHPixie\AuthLogin\Providers\Password(
